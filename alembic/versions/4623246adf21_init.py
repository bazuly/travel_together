...
Revision ID: 4623246adf21
Revises: 
Create Date: 2026-03-30 21:38:13.166599
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'ACCEPTED', 'REJECTED', 'LEFT', name='participantstatus'), nullable=False),
